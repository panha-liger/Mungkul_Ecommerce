      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => CheckoutWidget(
            deliveryOption: params.getParam('deliveryOption', ParamType.String),
            isGetinplace: params.getParam('isGetinplace', ParamType.bool),
          ),
        ),
        FFRoute(
          name: 'AdminDashboard',
        ...
        FFRoute(
          name: 'Signin_Admin',
          path: '/admin',
          builder: (context, params) => SigninAdminWidget(),
        ),
        FFRoute(
          name: 'Customer_List',
          path: '/customerList',
        ...
        FFRoute(
          ...
          builder: (context, params) => EditProductWidget(
            editProdutId: params.getParam('editProdutId', ParamType.String),
          ),
        ),
        FFRoute(
          name: 'my_Order',
        ...
        FFRoute(
          ...
          builder: (context, params) => ProductPageWidget(
            ...
            searchId: params.getParam('searchId', ParamType.String),
            discountId: params.getParam('discountId', ParamType.String),
            isDiscount: params.getParam('isDiscount', ParamType.bool),
          ),
        ),
        FFRoute(
          name: 'contact',
